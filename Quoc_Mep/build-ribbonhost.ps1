# Build RibbonHost for all Revit versions
param(
...
$project = "Quoc_MEP.RibbonHost\Quoc_MEP.RibbonHost.csproj"

Write-Host "=====================================" -ForegroundColor Cyan
Write-Host "Building RibbonHost for Revit Versions: $($Versions -join ', ')" -ForegroundColor Cyan
...
foreach ($version in $Versions) {
    ...
    try {
        ...
        & dotnet build $project /p:RevitVersion=$version /p:Configuration=$Configuration /v:minimal
